    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Container(),
          Pinned.fromPins(
            Pin(size: 34.2, end: 13.9),
            Pin(size: 31.0, start: 41.0),
            child: Stack(
              children: <Widget>[
                Container(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0.0, 0.0, 2.1, 2.5),
                        ),
                        Align(
                ...
                Pinned.fromPins(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Align(
                        alignment: Alignment(0.067, -0.307),
                        child: SizedBox(
                          width: 47.0,
                          height: 19.0,
                          child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 19.0, start: 18.0),
            Pin(size: 18.6, end: 24.3),
            child: SvgPicture.string(
              _svg_cx49,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 17.0, middle: 0.279),
            Pin(size: 17.0, end: 24.9),
            child: SvgPicture.string(
              _svg_vfs9dm,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 18.5, middle: 0.4978),
            Pin(size: 18.0, end: 24.9),
            child: SvgPicture.string(
              _svg_rwz1dk,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 18.0, end: 18.6),
            Pin(size: 12.0, end: 27.4),
            child: PageLink(
              links: [
                PageLinkInfo(
...
const String _svg_o9mf5a =
    '<svg viewBox="11.9 12.3 5.2 5.2" ><path transform="translate(11.9, 12.35)" d="M 5.199999809265137 5.199999809265137 L 0 0" fill="#000000" fill-opacity="0.0" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg>';
